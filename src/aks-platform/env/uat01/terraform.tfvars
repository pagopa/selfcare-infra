...
aks_user_node_pool = {
  ...
  node_count_min  = 1,
  node_count_max  = 3,
  node_labels     = { node_name : "aks-uat01-user", node_type : "user", "pagopa.it/node-scope" : "app" },
  node_taints     = [],
...
tls_checker_https_endpoints_to_check = [
  {
    https_endpoint = "api-pnpg.uat.selfcare.pagopa.it",
    alert_name     = "api-pnpg.uat.selfcare.pagopa.it",
    alert_enabled  = true,
    helm_present   = true,
  },
]
