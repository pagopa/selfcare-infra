...
eventhubs_pnpg_00 = [
  {
    ...
    message_retention = 1
    consumers = [
      "pnpg-onboarding-outcome-consumer-group",
      "pnpg-initiative-onboarding-statistics-group"
    ]
    keys = [
      {
  ...
  },
  {
    ...
    message_retention = 1
    consumers = [
      "pnpg-checkiban-evaluation-consumer-group",
      "pnpg-rewards-notification-checkiban-req-group"
    ]
    keys = [
      {
  ...
  },
  {
    ...
    message_retention = 1
    consumers = [
      "pnpg-checkiban-outcome-consumer-group",
      "pnpg-rewards-notification-checkiban-out-group"
    ]
    keys = [
      {
...
eventhubs_pnpg_01 = [
  {
    ...
    message_retention = 1
    consumers = [
      "pnpg-transaction-consumer-group",
      "pnpg-transaction-wallet-consumer-group",
      "pnpg-rewards-notification-transaction-group",
      "pnpg-initiative-rewards-statistics-group"
    ]
    keys = [
      {
  ...
  },
  {
    ...
    message_retention = 1
    consumers = [
      "pnpg-beneficiary-rule-update-consumer-group",
      "pnpg-reward-calculator-rule-consumer-group",
      "pnpg-rewards-notification-rule-consumer-group"
    ]
    keys = [
      {
