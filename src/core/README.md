...
| <a name="module_selc_container_app"></a> [selc\_container\_app](#module\_selc\_container\_app) | git::https://github.com/pagopa/terraform-azurerm-v3.git//container_app_environment | v7.8.0 |
