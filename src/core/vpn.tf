## VPN subnet
module "vpn_snet" {
  source                                    = "github.com/pagopa/terraform-azurerm-v3.git//subnet?ref=v8.93.1"
  name                                      = "GatewaySubnet"
...
module "vpn" {
  source = "github.com/pagopa/terraform-azurerm-v3.git//vpn_gateway?ref=v8.93.1"
...
module "dns_forwarder" {
  source              = "github.com/pagopa/terraform-azurerm-v3.git//dns_forwarder?ref=v8.93.1"
