...
module "vpn" {
  source = "github.com/pagopa/terraform-azurerm-v3.git//vpn_gateway?ref=v7.50.1"
...
module "dns_forwarder_snet" {
  source                                    = "github.com/pagopa/terraform-azurerm-v3.git//subnet?ref=v7.5.0"
...
module "dns_forwarder" {
  source              = "github.com/pagopa/terraform-azurerm-v3.git//dns_forwarder?ref=v7.50.1"
