...
module "vnet_aks_platform" {
  source = "github.com/pagopa/terraform-azurerm-v3.git//virtual_network?ref=v8.93.0"
...
module "vnet_peering_core_2_aks" {
  source = "github.com/pagopa/terraform-azurerm-v3.git//virtual_network_peering?ref=v8.93.0"
